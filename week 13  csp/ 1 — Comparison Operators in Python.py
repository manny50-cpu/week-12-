...
pasword= input("What is your password fr?")
if len(pasword) >=8 and any(char.isdigit() for char in pasword):
    print("Password is valid.")
else:
    print("Password is invalid, it must be atleast 8 characters long and have a digit")
